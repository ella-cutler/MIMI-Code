...
#define     Strobe_LE_R_E_pin 8 // SPI // ripgio
#define     Strobe_CS_L_pin 26 //SPI // pigpio



//#define   MCLK_pin  =7 //I2S GPIO4

#define     OE_ALL_u_L_pin 12 
#define     Mux0_pin 22
#define     Mux1_pin 23
#define     Mux2_pin 24
#define     Mux3_pin 25  // pigpio
#define     Strobe_CS_L 26 // pigpio
